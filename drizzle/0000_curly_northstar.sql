...
--> statement-breakpoint
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_department-id_departments_id_fk" FOREIGN KEY ("department-id") REFERENCES "public"."departments"("id") ON DELETE restrict ON UPDATE no action;